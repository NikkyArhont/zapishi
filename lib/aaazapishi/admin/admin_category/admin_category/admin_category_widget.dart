...
import '/aaazapishi/admin/admin_category/admin_create_cat/admin_create_cat_widget.dart';
...
class AdminCategoryWidget extends StatefulWidget {
  ...
  static String routeName = 'adminCategory';
  static String routePath = '/adminCategory';
