...
import 'admin_createservice_model.dart';
export 'admin_createservice_model.dart';

class AdminCreateserviceWidget extends StatefulWidget {
  const AdminCreateserviceWidget({
    super.key,
  ...
  @override
  State<AdminCreateserviceWidget> createState() =>
      _AdminCreateserviceWidgetState();
}

class _AdminCreateserviceWidgetState extends State<AdminCreateserviceWidget> {
  late AdminCreateserviceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCreateserviceModel());
