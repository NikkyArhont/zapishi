...
import 'admin_del_cat_model.dart';
export 'admin_del_cat_model.dart';

class AdminDelCatWidget extends StatefulWidget {
  const AdminDelCatWidget({
    super.key,
...
class _AdminDelCatWidgetState extends State<AdminDelCatWidget> {
  late AdminDelCatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminDelCatModel());
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: AlignmentDirectional(-1.0, 0.0),
              child: Text(
                'Категория будет удалена из приложения',
