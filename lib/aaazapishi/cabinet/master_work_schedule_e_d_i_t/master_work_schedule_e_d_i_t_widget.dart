...
import 'master_work_schedule_e_d_i_t_model.dart';
export 'master_work_schedule_e_d_i_t_model.dart';

class MasterWorkScheduleEDITWidget extends StatefulWidget {
  const MasterWorkScheduleEDITWidget({
    super.key,
    required this.masterDoc,
  });

  final MastersRecord? masterDoc;

  static String routeName = 'masterWorkScheduleEDIT';
  static String routePath = '/masterWorkScheduleEDIT';

  @override
  State<MasterWorkScheduleEDITWidget> createState() =>
      _MasterWorkScheduleEDITWidgetState();
}

class _MasterWorkScheduleEDITWidgetState
    extends State<MasterWorkScheduleEDITWidget> {
  late MasterWorkScheduleEDITModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasterWorkScheduleEDITModel());
                    ...
                    children: [
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(
                              CcabinetMasterEDITWidget.routeName,
                              queryParameters: {
                                'masterDOCC': serializeParam(
                                  widget.masterDoc,
                                  ParamType.Document,
                                ),
                              }.withoutNulls,
                              extra: <String, dynamic>{
                                'masterDOCC': widget.masterDoc,
                              },
                            );
                          },
                          text: 'Отмена',
