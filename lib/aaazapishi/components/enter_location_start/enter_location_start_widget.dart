...
import 'enter_location_start_model.dart';
export 'enter_location_start_model.dart';

class EnterLocationStartWidget extends StatefulWidget {
  const EnterLocationStartWidget({
    super.key,
  ...
  @override
  State<EnterLocationStartWidget> createState() =>
      _EnterLocationStartWidgetState();
}

class _EnterLocationStartWidgetState extends State<EnterLocationStartWidget> {
  late EnterLocationStartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnterLocationStartModel());

    _model.textController ??= TextEditingController(text: widget.oldCity);
                        ...
                        onPressed: (_model.choosenPlace == null)
                            ...
                            : () async {
                                await currentUserReference!
                                  ...
                                  city: _model.choosenPlace?.placeTitle,
                                  cityPlaceId: _model.choosenPlace?.placeId,
                                ));
                                ...
                                if ((_model.apiResultLatLon?.succeeded ??
                                  ...
                                  Navigator.pop(
                                      context, _model.choosenPlace?.placeTitle);
                                } else {
                                  await showDialog(
                                    context: context,
                                    builder: (dialogContext) {
