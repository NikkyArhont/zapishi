                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      valueOrDefault<String>(
                                        FFAppState().mainFilter.dateServ != null
                                            ? dateTimeFormat(
                                                "dd.MM.yy",
                                                FFAppState()
                                                    .mainFilter
                              ...
                              onChanged: (newValue) async {
                                ...
                                if (newValue) {
                                  FFAppState().updateMainFilterStruct(
                                    (e) => e..dateServ = getCurrentTimestamp,
                                  );
                                  safeSetState(() {});
                                } else {
                                  FFAppState().updateMainFilterStruct(
