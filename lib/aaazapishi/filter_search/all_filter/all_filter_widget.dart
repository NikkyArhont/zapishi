...
class _AllFilterWidgetState extends State<AllFilterWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.loadcat = await queryCategoryRecordOnce();
      _model.loadCats = _model.loadcat!.toList().cast<CategoryRecord>();
      safeSetState(() {});
    });
                                    ...
                                    child: Autocomplete<String>(
                                      ...
                                      optionsViewBuilder:
                                        ...
                                        return AutocompleteOptionsList(
                                          textFieldKey: _model.locationKey1,
                                          textController:
                                      ...
                                      onSelected: (String selection) {
                                        safeSetState(() =>
                                            _model.locationSelectedOption1 =
                                                selection);
                                        FocusScope.of(context).unfocus();
                                      },
                                      fieldViewBuilder: (
                      ...
                      Container(
                        ...
                        child: Autocomplete<String>(
                          ...
                          optionsViewBuilder: (context, onSelected, options) {
                            return AutocompleteOptionsList(
                              textFieldKey: _model.locationKey2,
                              textController: _model.locationTextController2!,
                              options: options.toList(),
                              onSelected: onSelected,
                              textStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                          ...
                          onSelected: (String selection) {
                            safeSetState(() =>
                                _model.locationSelectedOption2 = selection);
                            FocusScope.of(context).unfocus();
                          },
                          fieldViewBuilder: (
                            context,
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  if (_model.choosenCats ==
                                                      listCatItem.reference) {
                                                    _model.choosenCats = null;
                                                    safeSetState(() {});
                                                  } else {
                                                    _model.choosenCats =
                                                        listCatItem.reference;
