...
import 'enter_location_master_model.dart';
export 'enter_location_master_model.dart';

class EnterLocationMasterWidget extends StatefulWidget {
  const EnterLocationMasterWidget({
    super.key,
  ...
  @override
  State<EnterLocationMasterWidget> createState() =>
      _EnterLocationMasterWidgetState();
}

class _EnterLocationMasterWidgetState extends State<EnterLocationMasterWidget> {
  late EnterLocationMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnterLocationMasterModel());
