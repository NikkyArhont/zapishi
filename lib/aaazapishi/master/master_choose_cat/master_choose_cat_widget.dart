...
export 'master_choose_cat_model.dart';

class MasterChooseCatWidget extends StatefulWidget {
  const MasterChooseCatWidget({super.key});

  static String routeName = 'masterChooseCat';
  static String routePath = '/masterChooseCat';

  @override
  State<MasterChooseCatWidget> createState() => _MasterChooseCatWidgetState();
}

class _MasterChooseCatWidgetState extends State<MasterChooseCatWidget> {
  late MasterChooseCatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasterChooseCatModel());
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  return InkWell(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children:
                                                                          [
                                                                        if (thirdCategoryRecord.reference ==
                                                                            _model.choosenCat.lastOrNull)
                                                                          Icon(
                      ...
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: !(_model.choosenCat.isNotEmpty)
                              ...
                              : () async {
                                  context.pushNamed(
                                    MasterCreateServiceWidget.routeName,
                                    queryParameters: {
