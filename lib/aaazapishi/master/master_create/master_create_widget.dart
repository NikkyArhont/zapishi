                    ...
                    children: [
                      Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            'https://images.unsplash.com/photo-1628498188873-579210ce622e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxzdGFycnklMjBuaWdodHxlbnwwfHx8fDE3NTgwMDE1Mzl8MA&ixlib=rb-4.1.0&q=80&w=400',
                            width: 380.0,
                            height: 240.0,
                            fit: BoxFit.cover,
                          ),
                      ...
                      onTap: () async {
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            ...
                            safeSetState(() => _model.setRemoteAddres = value));
                            ...
                            onPressed: () async {
                              ...
                              if (selectedFiles != null) {
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadData9bt = false;
                                }
                                if (selectedUploadedFiles.length ==
                          ...
                          builder: (context) {
                            ...
                            return Row(
                              ...
                              children: List.generate(uploadDoc.length,
                                  (uploadDocIndex) {
                                final uploadDocItem = uploadDoc[uploadDocIndex];
                                return Stack(
                                  alignment: AlignmentDirectional(1.0, -1.0),
                                  children: [
                                    Padding(
                                    ...
                                    Align(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          _model
                                              .removeFromDocList(uploadDocItem);
                                          safeSetState(() {});
                                        },
                                      ),
                                    ),
                                      ...
                                      for (int loop1Index = 0;
                                        ...
                                        firestoreBatch
                                          ...
                                          ...createServicesRecordData(
                                            ...
                                            fixedPrice: currentLoop1Item.fixed,
