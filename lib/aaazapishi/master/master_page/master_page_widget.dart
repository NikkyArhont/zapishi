  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MastersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final masterPageMastersRecord = snapshot.data!;
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (!(currentUserDocument?.favoriteMasters
                                          .toList() ??
                                      [])
                                  .contains(widget.master))
                        ...
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              masterPageMastersRecord.banner,
                              width: 380.0,
                              height: 240.0,
                              fit: BoxFit.cover,
                            ),
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            formatNumber(
                                              masterPageMastersRecord.raiting,
                        ...
                        Builder(
                          builder: (context) {
                            final parent =
                                masterPageMastersRecord.parentCat.toList();
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(-1.0, 0.0),
                                child: Text(
                                  masterPageMastersRecord.adres.placeTitle,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(-1.0, 0.0),
                                child: Text(
                                  masterPageMastersRecord.remoteAdres != null
                                      ? 'Осуществляется'
                                      : 'Не осуществляется',
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(-1.0, 0.0),
                                child: Text(
                                  masterPageMastersRecord.years.toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily:
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                12.0, 0.0, 12.0, 0.0),
                            child: Text(
                              masterPageMastersRecord.description,
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                        ...
                        if (masterPageMastersRecord.docs.isNotEmpty)
                          Align(
                            alignment: AlignmentDirectional(-1.0, 0.0),
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        if (masterPageMastersRecord.docs.isNotEmpty)
                          Align(
                            ...
                            child: Builder(
                              builder: (context) {
                                final loadDocs =
                                    masterPageMastersRecord.docs.toList();
                            ...
                            stream: queryCategoryRecord(
                              queryBuilder: (categoryRecord) => categoryRecord
                                  ...
                                  .where(
                                    'masters',
                                    arrayContains:
                                        masterPageMastersRecord.reference,
                                  ),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                                                                                      ...
                                                                                      child: StreamBuilder<List<ServicesRecord>>(
                                                                                        stream: queryServicesRecord(
                                                                                          queryBuilder: (servicesRecord) => servicesRecord
                                                                                              ...
                                                                                              .where(
                                                                                                'organisation',
                                                                                                isEqualTo: masterPageMastersRecord.reference,
                                                                                              ),
                                                                                        ),
                                                                                        builder: (context, snapshot) {
                                                                                          // Customize what your widget looks like when it's loading.
                        ...
                        if (masterPageMastersRecord.type != UserStatus.manager)
                          Builder(
                            builder: (context) {
                              final employee =
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            RatingBarIndicator(
                                              ...
                                              rating: masterPageMastersRecord
                                                  .raiting,
                                              unratedColor:
                                                  FlutterFlowTheme.of(context)
                                                      .accent2,
                                                    ...
                                                    builder:
                                                      ...
                                                      return Row(
                                                        ...
                                                        children: [
                                                          AvatarMiniWidget(
                                                            key: Key(
                                                                'Keyfab_${loadREviewsIndex}_of_${loadREviews.length}'),
                                                            sizeAva: 54,
                                                            avaURL:
                                                                rowUserRecord
                                                                    .photoUrl,
