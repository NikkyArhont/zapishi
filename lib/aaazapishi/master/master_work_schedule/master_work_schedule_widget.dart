                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: ((_model.startWorkDay == null) ||
                                          (_model.workTextController.text ==
                                                  '') ||
                                          (_model.vacationTextController
                                                      .text ==
                                                  ''))
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              if (functions.sameMonth(
                                                  ...
                                                  (getCurrentTimestamp <=
                                                      updateCalendarItem)) {
                                                if (_model.setSchedule.contains(
                                                    updateCalendarItem)) {
                                                  _model.removeFromSetSchedule(
                                                      updateCalendarItem);
                                                  safeSetState(() {});
                                                } else {
                                            ...
                                            child: Container(
                                              ...
                                              height: 48.0,
                                              decoration: BoxDecoration(
                                                color: _model.setSchedule.contains(
                                                            updateCalendarItem) &&
                                                        functions.sameMonth(
                                                            updateCalendarItem,
                                                            _model
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.workTimeStart = _model.datePicked1;
                                      safeSetState(() {});
                                    },
                              ...
                              Switch.adaptive(
                                ...
                                onChanged: (newValue) async {
                                  ...
                                  if (newValue) {
                                    ...
                                    _model.workTimeEnd =
                                        _model.weeklySchedule.firstOrNull?.end;
                                    safeSetState(() {});
                                  }
                                },
                                activeColor: FlutterFlowTheme.of(context)
