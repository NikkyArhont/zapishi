...
import 'service_page_z_model.dart';
export 'service_page_z_model.dart';

class ServicePageZWidget extends StatefulWidget {
  const ServicePageZWidget({
    super.key,
  ...
  static String routeName = 'servicePageZ';
  static String routePath = '/servicePageZ';

  @override
  State<ServicePageZWidget> createState() => _ServicePageZWidgetState();
}

class _ServicePageZWidgetState extends State<ServicePageZWidget>
    with TickerProviderStateMixin {
  late ServicePageZModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServicePageZModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ServicesRecord>(
      stream: ServicesRecord.getDocument(widget.servRef!),
      builder: (context, snapshot) {
        ...
        final servicePageZServicesRecord = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<MastersRecord>(
                stream: MastersRecord.getDocument(
                    servicePageZServicesRecord.organisation!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final servPhoto =
                                      servicePageZServicesRecord.photo.toList();
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: PageView.builder(
                                            ...
                                            itemCount: servPhoto.length,
                                            itemBuilder:
                                                (context, servPhotoIndex) {
                                              final servPhotoItem =
                                                  servPhoto[servPhotoIndex];
                                              return Padding(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      servicePageZServicesRecord.title,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        servicePageZServicesRecord.price
                                            .toString(),
                                        style: FlutterFlowTheme.of(context)
                                            .headlineLarge
                                            .override(
                            ...
                            Align(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 12.0, 0.0),
                                child: Text(
                                  servicePageZServicesRecord.description,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                            ...
                            if (stackMastersRecord.type != UserStatus.manager)
                              Builder(
                                builder: (context) {
                                  final loadWOrker =
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '(${servicePageZServicesRecord.reviews.length.toString()})',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          return Row(
                                                            ...
                                                            children: [
                                                              AvatarMiniWidget(
                                                                key: Key(
                                                                    'Keyzvm_${loadREviewsIndex}_of_${loadREviews.length}'),
                                                                sizeAva: 54,
                                                                avaURL:
                                                                    rowUserRecord
                                                                        .photoUrl,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child:
                                                                        StarsWidget(
                                                                      key: Key(
                                                                          'Keyxeo_${loadREviewsIndex}_of_${loadREviews.length}'),
                                                                      parameter1:
                                                                          loadREviewsItem
                                                                              .star,
                                                                    ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Text(
                                            'Исполнитель добавлен в избранное',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
