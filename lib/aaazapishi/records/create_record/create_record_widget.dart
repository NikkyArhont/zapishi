                                                                    ...
                                                                    stream:
                                                                      ...
                                                                      queryBuilder: (categoryRecord) => categoryRecord
                                                                          ...
                                                                          .where(
                                                                            'masters',
                                                                            arrayContains:
                                                                                widget.organisationCard?.reference,
                                                                          ),
                                                                    ),
                                                                    builder:
                                                                        (context,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FlutterFlowIconButton(
                                          ...
                                          disabledIconColor: Color(0x78616161),
                                          icon: FaIcon(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return Wrap(
                                          ...
                                          children:
                                              List.generate(timeSchedule.length,
                                                  (timeScheduleIndex) {
                                            final timeScheduleItem =
                                                timeSchedule[timeScheduleIndex];
                                            return InkWell(
                                              splashColor: Colors.transparent,
                                              focusColor: Colors.transparent,
                                              hoverColor: Colors.transparent,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (currentUserDocument?.essence != UserStatus.user)
                              AuthUserStreamWidget(
                                builder: (context) => TextFormField(
                                  controller: _model.clientPhoneTextController,
