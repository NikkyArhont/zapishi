...
import '/aaazapishi/records/modal_wind_debate_open/modal_wind_debate_open_widget.dart';
import '/aaazapishi/records/record_cansel_client/record_cansel_client_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<RecordsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final recordPageRecordsRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<MastersRecord>(
                stream:
                    MastersRecord.getDocument(recordPageRecordsRecord.master!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) {
                                    final loadServ = recordPageRecordsRecord
                                        .services
                                        .toList();
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${recordPageRecordsRecord.duration.toString()} мин.',
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                                                fontFamily:
                                ...
                                if (recordPageRecordsRecord.status ==
                                    RecordStatus.newREc)
                                  Container(
                                    decoration: BoxDecoration(
                                      color: Color(0x19FACC15),
                                      borderRadius: BorderRadius.circular(16.0),
                                    ),
                                    child: Padding(
                                      padding: EdgeInsets.all(12.0),
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Ожидает подтверждения.\nДо подтверждения со стороны исполнителя \nзапись не считается действительной.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                ...
                                if ((recordPageRecordsRecord.status ==
                                        RecordStatus.complete) &&
                                    (recordPageRecordsRecord.revievs == null))
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        2.0, 0.0, 2.0, 0.0),
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed(
                                          ...
                                          extra: <String, dynamic>{
                                            'record': recordPageRecordsRecord,
                                          },
                                        );
                                      },
                                      text: 'Оценить',
