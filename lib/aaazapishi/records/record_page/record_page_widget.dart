                        ...
                        children: [
                          ...
                          StreamBuilder<MastersRecord>(
                            stream: MastersRecord.getDocument(
                                recordPageRecordsRecord.master!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            containerMastersRecord.manager,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                                                  fontFamily:
                          ...
                          Builder(
                            builder: (context) {
                              final loadServ =
                                  recordPageRecordsRecord.services.toList();
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, loadServIndex) {
                                  final loadServItem = loadServ[loadServIndex];
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    recordPageRecordsRecord.location.placeTitle,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                                          fontFamily:
                                      ...
                                      builder: (dialogContext) {
                                        return Dialog(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: RecordCanselClientWidget(
                                              recordCard:
                                                  recordPageRecordsRecord,
                                            ),
                                          ),
