...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF679249);
  late Color secondary = const Color(0xFFC9D3B4);
  late Color tertiary = const Color(0xFFDFD4A6);
  late Color alternate = const Color(0xFFE4EAD6);
